...
import (
	...
	"github.com/deshmukhpurushothaman/go-room-bookings/internal/repository/dbrepo"
)
...
// The functions starting with a capital letter are exported functions
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	form := forms.New(r.PostForm)
	for _, x := range rooms {
		// Get the blockMap from session. Loop through the map, if we have an entry in map
